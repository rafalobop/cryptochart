      ...
      <div className='grid md:grid-cols-2 gap-8 '>
        <div>
          ...
          <div className='flex justify-between py-4'>
            ...
            <div>
              <p className='text-gray-500 text-sm'>Volume (24hs)</p>
              {coin.market_data?.market_cap ? (<p>${coin.market_data.total_volume.usd.toLocaleString()}</p>) : null}
            </div>
          </div>
          <div className='flex justify-between py-4'>
            <div>
              <p className='text-gray-500 text-sm'>24hs High</p>
              {coin.market_data?.high_24h ? (<p>${coin.market_data.high_24h.usd.toLocaleString()}</p>) : null}
            </div>
            <div>
              <p className='text-gray-500 text-sm'>24hs Low</p>
        ...
        <div>
          ...
          <div className='flex justify-between py-4'>
            <div>
              <p className='text-gray-500 text-sm'>Price Change (24hs)</p>
